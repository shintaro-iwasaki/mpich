...
for winsize in ${winsize_list}; do
    for repeat in $(seq 20); do
        echo "# repeat $repeat / 10"
        num_entities="16"
        num_messages="100000"
        msgsize_list="1 4 16 64 256 1024 4096 16384 65536 262144"
        for msgsize in $msgsize_list; do
            ...
            date
            echo "#### proc $num_messages $num_entities $winsize $msgsize"
            ...
            date
            echo "#### pth_novci_1comm $num_messages_sp $num_entities $winsize $msgsize"
            ...
            if [ x"$full" != x0 ]; then
                date
                echo "#### pth_novci_Ncomm $num_messages_sp $num_entities $winsize $msgsize"
                ...
                date
                echo "#### pth_vci_1comm $num_messages_sp $num_entities $winsize $msgsize"
                ...
                date
                echo "#### pth_vci_Ncomm $num_messages $num_entities $winsize $msgsize"
                ...
                date
                echo "#### pth_vci_Ncomm_nolock_1comm $num_messages $num_entities $winsize $msgsize"
            ...
            date
            echo "#### pth_vciopt_Ncomm $num_messages $num_entities $winsize $msgsize"
            ...
            date
            echo "#### pth_vciopt_Ncomm_nolock $num_messages $num_entities $winsize $msgsize"
            ...
            date
            echo "#### abt_vci_1comm_Nes $num_messages $num_entities $winsize $msgsize"
            ...
            if [ x"$full" != x0 ]; then
                date
                echo "#### abt_vci_1comm_1es $num_messages $num_entities $winsize $msgsize"
                ...
                date
                echo "#### abt_vci_Ncomm_1es $num_messages $num_entities $winsize $msgsize"
            ...
            date
            echo "#### abt_vci_Ncomm_Nes $num_messages $num_entities $winsize $msgsize"
